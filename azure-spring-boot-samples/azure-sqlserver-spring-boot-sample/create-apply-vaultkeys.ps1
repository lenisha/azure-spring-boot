...
# Authenticate to Azure SQL Server (in this example using same credential as login)
...
# Add changes for table [dbo].[person]
$encryptionChanges += New-SqlColumnEncryptionSettings -ColumnName dbo.person.first_name -EncryptionType Deterministic -EncryptionKey $cekName
